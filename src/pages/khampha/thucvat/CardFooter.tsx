...
import { fetchThucvat } from "../../../features/thucvatSlice_footer";

const CardFooter: React.FC = () => {
 
  const dispatch = useAppDispatch();
  const { thucvat, loading, error } = useAppSelector((state) => state.thucvat);
  ...
  useEffect(() => {
    console.log("Redux State - services: ", thucvat); // Kiểm tra dữ liệu Redux
  }, [thucvat]);
