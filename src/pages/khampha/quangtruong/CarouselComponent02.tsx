...
const CarouselComponent: React.FC<CarouselComponentProps> = () => {
  ...
  useEffect(() => {
    console.log("Redux State - services: ", quangtruongslider3); 
  }, [quangtruongslider3]);
  ...
  const settings = {
    ...
    customPaging: (i: number) => (
      <img
        src={quangtruongslider3[i].imageUrl}
        alt={`thumbnail-${i}`}
  ...
  return (
    <div className="carousel-container">
      ...
      <div className="caption">{quangtruongslider3[currentSlide]?.description || "No description available"}</div>
    </div>
  );
};
