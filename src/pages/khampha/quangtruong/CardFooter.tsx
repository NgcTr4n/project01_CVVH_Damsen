...
import { fetchQuangtruong } from "../../../features/quangtruongSlice_footer";

const CardFooter: React.FC = () => {
  const dispatch = useAppDispatch();
  const { quangtruong, loading, error } = useAppSelector((state) => state.quangtruong);
  ...
  useEffect(() => {
    console.log("Redux State - services: ", quangtruong); // Kiểm tra dữ liệu Redux
  }, [quangtruong]);
